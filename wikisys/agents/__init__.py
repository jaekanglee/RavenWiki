"""wikisys.agents — adapters for non-human vault users (Hermes/Claude/Codex).

Why this exists:
    Humans use the CLI (`wikisys ...`) or the GUI (browser). Agents (LLM
...
Public surface (all under wikisys.agents):
