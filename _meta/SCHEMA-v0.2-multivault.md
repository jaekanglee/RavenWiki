...
**개발단 원칙**: Raven은 도구. vault 내부의 프로젝트 디렉토리 구조는 사용자가 결정. 개발단은 어떤 도메인/프로젝트가 있는지 가정하지 않음.
